...
const categories = [
  { id: 1, name: "Mobiles", icon: "📱", color: "#00f2fe" },
  { id: 2, name: "Relojes", icon: "⌚", color: "#ff0844" },
  { id: 3, name: "Electronicos", icon: "💻", color: "#4facfe" },
  { id: 4, name: "Accesorios", icon: "🎧", color: "#ffb199" },
  { id: 5, name: "Cosmeticos", icon: "💄", color: "#ff6b6b" },
  { id: 6, name: "Muebles", icon: "🪑", color: "#00d2ff" },
